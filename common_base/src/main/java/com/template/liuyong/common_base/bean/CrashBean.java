package com.template.liuyong.common_base.bean;
 ...
 * @package 包名 com.template.liuyong.common_base.bean
 * @describe 类描述
 * @time 创建时间 2019/1/22 14:46
 * @change 修改内容
 * @changetime 修改时间
 * @changeauthor 修改人
 */
public class CrashBean  implements Parcelable {
    ...
    public static final Creator<CrashBean> CREATOR = new Creator<CrashBean>() {
        @Override
        public CrashBean createFromParcel(Parcel in) {
            return new CrashBean(in);
        }

        @Override
        public CrashBean[] newArray(int size) {
            return new CrashBean[size];
        }
    };
